...
UNO_PINOUT = IoPinout({
    0 : IoParams(CAP_GPIO,              0, "PD0"),
    1 : IoParams(CAP_GPIO,              1, "PD1"),
    2 : IoParams(CAP_GPIO,              2, "PD2"),
    3 : IoParams(CAP_GPIO,              3, "PD3"),
    4 : IoParams(CAP_GPIO,              4, "PD4"),
    5 : IoParams(CAP_GPIO,              5, "PD5"),
    6 : IoParams(CAP_GPIO,              6, "PD6"),
    7 : IoParams(CAP_GPIO,              7, "PD7"),
    8 : IoParams(CAP_GPIO,              8, "PB0"),
    9 : IoParams(CAP_GPIO,              9, "PB1"),
    10: IoParams(CAP_GPIO,             10, "PB2"),
    11: IoParams(CAP_GPIO,             11, "PB3"),
    12: IoParams(CAP_GPIO,             12, "PB4"),
    13: IoParams(CAP_GPIO,             13, "PB5")
})

LEONARDO_PINOUT = IoPinout({
    0 : IoParams(CAP_GPIO,              0, "PD2"),
    1 : IoParams(CAP_GPIO,              1, "PD3"),
    2 : IoParams(CAP_GPIO,              2, "PD1"),
    3 : IoParams(CAP_GPIO,              3, "PD0"),
    4 : IoParams(CAP_GPIO,              4, "PD4"),
    5 : IoParams(CAP_GPIO,              5, "PC6"),
    6 : IoParams(CAP_GPIO,              6, "PD7"),
    7 : IoParams(CAP_GPIO,              7, "PE6"),
    8 : IoParams(CAP_GPIO,              8, "PB4"),
    9 : IoParams(CAP_GPIO,              9, "PB5"),
    10: IoParams(CAP_GPIO,             10, "PB6"),
    11: IoParams(CAP_GPIO,             11, "PB7"),
    12: IoParams(CAP_GPIO,             12, "PD6"),
    13: IoParams(CAP_GPIO,             13, "PC7")
})
